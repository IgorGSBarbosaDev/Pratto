              ...
              <section className="py-10">
                ...
                {context.establishments.length === 0 ? (
                  ...
                  <div className="mt-7">
                    ...
                    <section className="mt-10">
                      <h2 className="text-xl font-semibold">Publicação e compartilhamento</h2>
                      <p className="mt-2 max-w-2xl text-slate-400">
                        Publique uma versão imutável e compartilhe o acesso público pelo link ou QR
                        Code.
                      </p>
                      <div className="mt-7">
                        <PublicationManagement
                          establishmentId={context.establishments[0]!.id}
